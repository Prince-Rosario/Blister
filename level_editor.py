...
for x in range(TILE_TYPES):
	img = pygame.image.load(f'files/img/tile/{x}.png').convert_alpha()
	img = pygame.transform.scale(img, (TILE_SIZE, TILE_SIZE))
	img_list.append(img)

save_img = pygame.image.load('files/img/save.png').convert_alpha()
load_img = pygame.image.load('files/img/load.png').convert_alpha()
...
while run:
	...
	if save_button.draw(screen):
		#save level data
		with open(f'files/level{level}_data.csv', 'w', newline='') as csvfile:
