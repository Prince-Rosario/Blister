...
ammo_box_img = pygame.image.load("files/img/icons/ammo_box.png").convert_alpha()
grenade_box_img = pygame.image.load("files/img/icons/grenade_box.png").convert_alpha()
item_boxes = {
        ...
        for animation in animation_types:
            ...
            for i in range(num_of_frames):
                img = pygame.image.load(
                    f"files/img/{self.char_type}/{animation}/{i}.png"
                ).convert_alpha()
            ...
            for x, tile in enumerate(row):
                if tile >= 0:
                    ...
                    if tile >= 0 and tile <= 8:
                        ...
                        player = Soldier(
                            "player", x * TILE_SIZE, y * TILE_SIZE, 1.5, 5, 20, 5
                        )
